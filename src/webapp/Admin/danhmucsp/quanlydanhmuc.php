...
<body>
    <div>
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class='update' href="trangadmin.php?page_layout=suasp&id=<?php echo $row['id']; ?>">Cập nhật</a>
                </td>
            </tr>
            <?php
                }
        ...
        <br>
        <a class="add" href="trangadmin.php?page_layout=themsanpham">Thêm sản phẩm</a>
    </div>
